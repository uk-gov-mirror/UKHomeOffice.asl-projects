...
const NTS = ({ accepted, onAccept, review, hideTitle }) => (
  <div className="nts">
    ...
    <p>As an NTS is a public document, do not include any information that could identify any people, locations, or intellectual property related to your project. You will be able to review your NTS as a whole before you submit your licence application</p>
    {
      !review && (
