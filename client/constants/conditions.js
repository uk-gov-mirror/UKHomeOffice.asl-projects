  ...
  protocol: {
    ...
    reuse: {
      ...
      versions: [
        {
          title: 'Re-use',
          content: '<<<INSERT animal type(s) HERE>>> may be re-used in this protocol where re-use is proposed from this protocol, from another protocol or from another project, provided that all criteria in section 14 of the Animals (Scientific Procedures) Act and in this project licence are fulfilled.'
        }
      ]
    },
    'continued-use': {
      ...
      versions: [
        {
          ...
          content: 'Unless otherwise specified, all animals are expected to make a rapid and unremarkable recovery from the anaesthetic within two hours. Uncommonly animals that fail to do so or exhibit signs of pain, distress or of significant ill health should be killed unless a programme of enhanced monitoring and care is instituted until the animal fully recovers.'
        }
      ]
    },
    surgery: {
...
* Any animal not fully recovered from the surgical procedure within 24 hrs (eating, drinking and return to normal behaviour) should be killed.`
        }
      ]
    },
    'admin-of-substances': {
      ...
      versions: [
        {
          title: 'Administration of substances and withdrawal of fluids',
